...
//-check & --check function for old adns_tsar amon usage
#define OLDTSAR
...
#define DEFAULT_CONF_FILE_PATH      "/etc/adns_tsar/adns_tsar.conf"
#define DEFAULT_OUTPUT_FILE_PATH    "/var/log/adns_tsar.data"
