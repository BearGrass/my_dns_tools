...
usage()
{
    ...
    fprintf(stderr,
            ...
            /*end*/
#endif
            "    --check/-C     display last record for alert.example:adns_tsar --check / adns_tsar --check --cpu --io\n"
            ...
            "    --spec/-s      show spec field data, adns_tsar --cpu -s sys,util\n"
            "    --item/-I      show spec item data, adns_tsar --io -I sda\n"
            "    --help/-h      help\n");
...
main_init(int argc, char **argv)
{
    ...
    if (access(conf.config_file, F_OK)) {
        do_debug(LOG_FATAL, "main_init: can't find adns_tsar.conf");
    }
}
...
running_list()
{
    ...
    printf("adns_tsar enable follow modules:\n");
