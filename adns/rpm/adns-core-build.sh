...
cp adns-core.tar.gz $ABS_PATH/$TOP_DIR/SOURCES

export $RTE_KERNELDIR=/lib/modules/`ls /libs/modules`/build

# set rpm buildroot
rpmbuild -bb rpm/adns-core.spec --buildroot=$ABS_PATH/$TOP_DIR/BUILDROOT --define '_40g_opt 0' --define '_ipv6_opt 0' --define '_pvtz_opt 0'
