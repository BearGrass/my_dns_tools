...
cp adns-core.tar.gz $ABS_PATH/$TOP_DIR/SOURCES/adns-core_40G_IPV6.tar.gz
# set rpm buildroot
rpmbuild -bb rpm/adns-core_40G_IPV6.spec --buildroot=$ABS_PATH/$TOP_DIR/BUILDROOT --define '_40g_opt 1' --define '_ipv6_opt 1' --define '_pvtz_opt 0'
