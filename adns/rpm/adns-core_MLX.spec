...
sed -i 's/CONFIG_RTE_LIBRTE_MLX5_PMD=n/CONFIG_RTE_LIBRTE_MLX5_PMD=y/g' x86_64-native-linuxapp-gcc/.config 
...
unset RTE_SDK
unset RTE_TARGET
make MLX=%{_mlx_opt} PVT_ZONE=%{_pvtz_opt} IPV6=%{_ipv6_opt}
make install PACKAGING=1 MLX=%{_mlx_opt} PVT_ZONE=%{_pvtz_opt} IPV6=%{_ipv6_opt}
cp ${DEP_VAR}/../../../extern/ndns extern/ -r
...
install -m755 scm/hiadns-a-190g-ndns/* %{buildroot}%{_prefix}/scm/hiadns-a-190g-ndns
install -m755 scm/hiadns-v-190g-ndns/* %{buildroot}%{_prefix}/scm/hiadns-v-190g-ndns
install -m755 scm/hiadns-v-95g-ndns/* %{buildroot}%{_prefix}/scm/hiadns-v-95g-ndns
install -m755 scm/corp/* %{buildroot}%{_prefix}/scm/corp
install -m755 scm/*.sh %{buildroot}%{_prefix}/scm
