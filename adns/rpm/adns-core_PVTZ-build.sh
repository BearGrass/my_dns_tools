...
cp adns-core.tar.gz $ABS_PATH/$TOP_DIR/SOURCES/adns-core_PVTZ.tar.gz
# set rpm buildroot
rpmbuild -bb rpm/adns-core_PVTZ.spec --buildroot=$ABS_PATH/$TOP_DIR/BUILDROOT --define '_40g_opt 0' --define '_ipv6_opt 0' --define '_pvtz_opt 1'
