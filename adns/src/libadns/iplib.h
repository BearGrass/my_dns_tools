...
static inline char *rm_whitespace(char *string)
{
...
extern char *g_ipv6file_path;
inline adns_viewid_t ip_bitmap_get(uint32_t ip, adns_socket_id_t socket_id);
inline adns_viewid_t ipv6_bitmap_get(struct in6_addr ipaddr, adns_socket_id_t socket_id);
int iplib_load_init();
int iplib_init();
void iplib_cleanup();
