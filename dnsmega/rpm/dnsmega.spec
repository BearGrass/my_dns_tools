%define kernel_version 3.10.0-327.ali2012.alios7
...
#export kernel_version=3.10.0-327.ali2012.alios7
export __KERNEL_DIR__=${DEP_VAR}/usr/src/kernels/%{kernel_version}.x86_64
make -C src/knl
make -C src/util
cd -
...
<<<<<<< HEAD
cp $OLDPWD/../dnsmega/src/knl/$MOD_NAME.ko $RPM_BUILD_ROOT/lib/modules/%{kernel}/dns/
=======
cp $OLDPWD/../dnsmega/src/knl/$MOD_NAME.ko $RPM_BUILD_ROOT/lib/modules/${KERNEL_RELEASE}/dns/
>>>>>>> 7udev
cp $OLDPWD/../dnsmega/src/util/dnsmega_adm $RPM_BUILD_ROOT/usr/bin/
cp $OLDPWD/../dnsmega/script/dnsmega $RPM_BUILD_ROOT/usr/bin/
cp $OLDPWD/../dnsmega/script/dnsmega.modules $RPM_BUILD_ROOT/etc/sysconfig/modules/
