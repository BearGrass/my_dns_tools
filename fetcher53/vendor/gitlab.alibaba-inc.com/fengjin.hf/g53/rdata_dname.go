...
func (c *DName) Rend(r *MsgRender) error {
	return rendField(RDF_C_NAME, c.Target, r)
}

func (c *DName) ToWire(buffer *buffer.OutputBuffer) error {
	return fieldToWire(RDF_C_NAME, c.Target, buffer)
}
...
func DNameFromWire(buffer *buffer.InputBuffer, ll uint16) (*DName, error) {
