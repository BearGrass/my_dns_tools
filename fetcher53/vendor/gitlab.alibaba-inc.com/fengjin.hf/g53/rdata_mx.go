...
func (mx *MX) Rend(r *MsgRender) error {
	if err := rendField(RDF_C_UINT16, mx.Preference, r); err != nil {
		return err
	}

	return rendField(RDF_C_NAME, mx.Exchange, r)
}

func (mx *MX) ToWire(buf *buffer.OutputBuffer) error {
	if err := fieldToWire(RDF_C_UINT16, mx.Preference, buf); err != nil {
		return err
	}

	return fieldToWire(RDF_C_NAME, mx.Exchange, buf)
}
...
func MXFromWire(buf *buffer.InputBuffer, ll uint16) (*MX, error) {
