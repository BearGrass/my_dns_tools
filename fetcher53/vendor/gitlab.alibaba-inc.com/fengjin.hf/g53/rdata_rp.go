...
func (rp *RP) Rend(r *MsgRender) error {
	if err := rendField(RDF_C_NAME, rp.Mbox, r); err != nil {
		return err
	}

	return rendField(RDF_C_NAME, rp.Txt, r)
}

func (rp *RP) ToWire(buf *buffer.OutputBuffer) error {
	if err := fieldToWire(RDF_C_NAME, rp.Mbox, buf); err != nil {
		return err
	}

	return fieldToWire(RDF_C_NAME, rp.Txt, buf)
}
...
func RPFromWire(buf *buffer.InputBuffer, ll uint16) (*RP, error) {
