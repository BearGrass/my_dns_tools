...
func (txt *Txt) Rend(r *MsgRender) error {
	return rendField(RDF_C_TXT, txt.Data, r)
}

func (txt *Txt) ToWire(buf *buffer.OutputBuffer) error {
	return fieldToWire(RDF_C_TXT, txt.Data, buf)
}
...
func TxtFromWire(buf *buffer.InputBuffer, ll uint16) (*Txt, error) {
